...
每次同时读写的数据大小=<CPU字长>,并且32位CPU只能4*K地址读写
读写不同地址的内存时间相同
...
<img src="media/image-20220418150329414.png" alt="image-20220418150329414" style="zoom:50%;" />
...
<img src="media/image-20220418150705290.png" alt="image-20220418150705290" style="zoom:50%;" />
...
<img src="media/固定分区分配方式.png" style="zoom:48%;" />
